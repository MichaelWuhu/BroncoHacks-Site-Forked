      ...
      <>
        <div className="db-container">
          <div className="db-title-wrapper">
            <img className="db-logo" src="../Static-Site/src/Assets/Profile/icon/BroncoHacks_Logo.png" alt="BroncoHacks Logo"/>
          ...
          <div className="db-content-wrapper">
            <img className="db-mascot" src="../Static-Site/src/Assets/DescriptionBox/imgs/cppBroncoMascot.png" alt="Bronco Mascot"/>
